...
import { Permissions, settingsKey, Tokens } from "./constants";
...
function App() {
    ...
    const permissionMappings = {
        ...
        manage_customer_dashboard: "/app/dashboard",
        manage_customer_purchases: "/app/customer-purchases",
    ...
    useEffect(() => {
        if (mappedRoutes && mappedRoutes.length > 0) {
            if (config.includes(Permissions.MANAGE_DASHBOARD) || config.includes(Permissions.MANAGE_CUSTOMER_DASHBOARD)) {
