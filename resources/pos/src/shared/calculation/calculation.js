...
//     const discountValue = parseFloat(inputValue.discount) || 0;
//     const taxRate = parseFloat(inputValue.tax_rate) || 0;
//     const shipping = parseFloat(inputValue.shipping) || 0;

//     let discountAmount = 0;

//     if (inputValue.discount_type === 1 || inputValue.discount_type === '1') {
...
//     const finalTotal = totalAfterDiscount + taxAmount + shipping;

//     return finalTotal.toFixed(2);
// };

export const customMultiply = function(a, b) {
