            ...
            <tr key={index} className="align-middle text-nowrap">
                ...
                <td>
                    {currencySymbolHandling(
                       ...
                       parseFloat(amountBeforeTax(singleProduct)).toFixed(decimalPlaces)
                    )}
                </td>
                <td>
...
const mapStateToProps = (state) => {
    const { productSales, allConfigData , settings } = state;
    return { productSales, allConfigData , settings };
};
