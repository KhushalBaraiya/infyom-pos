...
import { decimalValidate, getDecimalPlaces, getFormattedMessage, getFormattedOptions } from "../../sharedMethod";
...
const mapStateToProps = (state) => {
    const { productSales, products, posAllProducts, settings } = state;
    return { productSales, products, posAllProducts, settings };
};
