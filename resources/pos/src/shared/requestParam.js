...
export default (
    ...
    if (filters.direction_type === 1) {
        ...
        url = url + "direction_type=" + filters.direction_type;
    }else{
        if (
                baseUrl.indexOf("?") > 0 ||
                (url.includes("?") && url.length > 1)
        ...
        url = url + "direction_type=" + (filters.direction_type==undefined ? "" : filters.direction_type);
    }
    ...
    if (filters.fiscal_year_id) {
        ...
        url = url + "fiscal_year_id=" + filters.fiscal_year_id;
    }
