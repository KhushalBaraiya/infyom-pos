...
import { decimalValidate, getDecimalPlaces, getFormattedMessage, getFormattedOptions, placeholderText } from "../../shared/sharedMethod";
...
const CreateSubProductModal = (props) => {
    ...
    const onProductDataChange = (e) => {
       const { name, value } = e.target;
        ...
        // Decimal fields
        const decimalFields = ["product_cost", "product_price", "order_tax"];
