                        ...
                        <div className='col-md-12'>
                            <table className="table table-bordered table-sm mt-4">
                                <tbody className='fw-normal'>
                                    <tr>
                                        <td>{getFormattedMessage( "globally.input.name.label" )}</td>
                                    ...
                                    <tr>
                                        <td>{getFormattedMessage( 'globally.input.note.label' )}</td>
                                        <td><span className='badge bg-light-success'><span>{getFormattedMessage( "globally.optional-input.validate.label" )}</span></span></td>
                                    </tr>
                                    <tr>
                                        <td>{getFormattedMessage( "warehouse.title" )}</td>
                                        <td><span className='badge bg-light-success'><span>{getFormattedMessage( "globally.optional-input.validate.label" )}</span></span></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>{getFormattedMessage( "variation.title" )}</td>
                                        <td><span className='badge bg-light-success'><span>{getFormattedMessage( "globally.optional-input.validate.label" )}</span></span><span className='fw-bold'> {getFormattedMessage( "variation.import.optional-highlight.message" )}</span></td>
                                    </tr>
                                    <tr>
                                        <td>{getFormattedMessage( "variation.type.title" )}</td>
                                        <td><span className='badge bg-light-success'><span>{getFormattedMessage( "globally.optional-input.validate.label" )}</span></span><span className='fw-bold'> {getFormattedMessage( "variation-type.import.optional-highlight.message" )}</span></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
