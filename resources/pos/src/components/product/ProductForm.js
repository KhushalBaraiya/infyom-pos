...
const ProductForm = (props) => {
    ...
    useEffect(() => {
        if (singleProduct) {
            setProductValue({
                ...
                code: isDuplicate ? generateBarCode() : singleProduct ? singleProduct[0].code : "",
                ...
                product_type: singleProduct
                    ? singleProduct[0].product_type == 1
                        ...
                        : {
                              value: 2,
                              label: getFormattedMessage("variation.title"),
                          }
                    : "",
                variation: singleProduct
                    ? singleProduct[0].variation
                        ? {
                              value: singleProduct[0].variation.id,
                              label: singleProduct[0].variation.name,
                          }
                        : ""
                    : "",
            });
    ...
    const validateVariationTypesData = () => {
        ...
        const codeFrequency = variationTypesData.reduce(
            (acc, variationType) => {
    ...
    const handleValidation = () => {
        ...
        if (
            ...
            if (!singleProductTypeData?.add_stock && productType == 1) {
    ...
    const onSingleProductDataChange = (e) => {
        ...
        // Block wholesale/special price from exceeding retail (product_price)
        ...
        // Block retail price from going below existing wholesale/special prices
        if (name === 'product_price') {
            const typedRetail = parseFloat(value);
    ...
    const prepareFormData = () => {
        ...
        if (productValue.expiry_date) {
            formData.append(
                "expiry_date",
                moment(productValue.expiry_date)
                    .locale("en")
                    .format("YYYY-MM-DD")
            );
        }
                ...
                formData.append(
                    ...
                    JSON.stringify(
                        variationTypesData.map((variationType) => ({
                            ...
                            ...(settings?.attributes
                                ?.add_stock_while_product_creation == "1"
    ...
    return (
        <div className="card">
            <TabTitle title={placeholderText(id ? "product.edit.title" : "product.create.title")}/>
                        ...
                        <div className="col-xl-4">
                            ...
                            {isEdit ? (
                                ""
                                  ...
                                  ?.add_stock_while_product_creation == "0" ? (
                                ""
                            ) : (
                                <div>
                                    <div className="col-md-12 mb-3">
