...
const ProductDetail = (props) => {
    ...
    const IsWholesalePrice = allProducts?.map((product) => {
    ...
    return (
        <MasterLayout>
            <TopProgressBar />
            <HeaderTitle
                editLink={getPermission(allConfigData?.permissions, Permissions.EDIT_PRODUCTS) && `/app/products/edit/${id}`}
                        ...
                        <tbody>
                            {allProducts && allProducts.map((data, index) =>
                                ...
                                <tr key={index}>
                                    ...
                                    <td className="py-4">
                                        {data.product_wholesale_price ? currencySymbolHandling(
                                            allConfigData,
                                            frontSetting.value &&
                                            frontSetting.value
                                                .currency_symbol,
                                    ...
                                    <td className="py-4">
                                        {data.product_special_price ? currencySymbolHandling(
                                            allConfigData,
                                            frontSetting.value &&
                                            frontSetting.value
                                                .currency_symbol,
                                    ...
                                    <td className="py-4">
                                        <div className="text-center">
                                            {getPermission(allConfigData?.permissions, Permissions.VIEW_PRODUCTS) && 
                                            ...
                                            {getPermission(allConfigData?.permissions, Permissions.DELETE_PRODUCTS) && product.attributes.product_type == 2 && allProducts.length > 1 &&
