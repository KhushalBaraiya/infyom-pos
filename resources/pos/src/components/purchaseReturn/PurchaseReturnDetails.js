    ...
    return (
        <MasterLayout>
            ...
            <HeaderTitle
                ...
                editLink={getPermission(allConfigData?.permissions, Permissions.EDIT_PURCHASE_RETURN) && `/app/purchase-return/edit/${id}`}
            />
            <TabTitle
                        ...
                        <Row className="custom-line-height">
                            <Col md={4}>
                                ...
                                <div className="p-4">
                                    ...
                                    {purchaseReturnDetails.supplier &&
                                            purchaseReturnDetails.supplier
                                                .email && <div className="d-flex align-items-center pb-1">
                                        <FontAwesomeIcon
                                            icon={faEnvelope}
                                            className="text-primary me-2 fs-5"
                                        />
                                    ...
                                    {purchaseReturnDetails.supplier &&
                                            purchaseReturnDetails.supplier
                                                .phone && <div className="d-flex align-items-center pb-1">
                                        <FontAwesomeIcon
                                            icon={faMobileAlt}
                                            className="text-primary me-2 fs-5"
                                        />
                                ...
                                <div className="p-4">
                                    <div className="d-flex align-items-center pb-1">
                                        ...
                                        {purchaseReturnDetails.company_info &&
                                            (purchaseReturnDetails.company_info.company_name ?? "N/A")} 
                                    </div>
                                    <div className="d-flex align-items-center pb-1">
                                        <FontAwesomeIcon
                                            icon={faEnvelope}
                                        ...
                                        />
                                        {purchaseReturnDetails.company_info &&
                                            (purchaseReturnDetails.company_info.email ?? "N/A")}
                                    </div>
                                    <div className="d-flex align-items-center pb-1">
                                        <FontAwesomeIcon
                                            icon={faMobileAlt}
                                        ...
                                        />
                                        {purchaseReturnDetails.company_info &&
                                            (purchaseReturnDetails.company_info.phone ?? "N/A")}
                                    </div>
                                    <div className="d-flex align-items-center">
                                        ...
                                        />
                                        {purchaseReturnDetails.company_info &&
                                            (purchaseReturnDetails.company_info.address ?? "N/A")}
                                    </div>
                                </div>
                            </Col>
                            <Col md={4}>
