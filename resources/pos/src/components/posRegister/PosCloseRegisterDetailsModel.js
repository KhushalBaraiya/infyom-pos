        ...
        if (closeRegisterDetails) {
            setFormsValue((data) => ({
                ...
                cash_in_hand_while_closing: closeRegisterDetails
                    ? parseFloat(closeRegisterDetails?.total_cash_amount)?.toFixed(2)
                    : 0,
            }));
        }
                ...
                <Modal.Body>
                    ...
                    >
                        <tbody>
                            ...
                            {closeRegisterDetails?.payment_methods?.map(
                                (paymentMethod, index) => (
                            ...
                            {(!closeRegisterDetails?.payment_methods ||
                                closeRegisterDetails?.payment_methods
                                    ?.length === 0) && (
                                <>
                                    <tr>
                            ...
                            {/* <tr>
                                ...
                                <td>
                                    {currencySymbolHandling(
                                        allConfigData,
                                        currencySymbol,
                                        closeRegisterDetails?.total_unpaid_amount
                                    )}
                                </td>
                            </tr> */}
                            <tr>
                                ...
                                <td>
                                    {currencySymbolHandling(
                                        allConfigData,
                                        currencySymbol,
                                        closeRegisterDetails?.total_payment_amount
                                    )}
                                </td>
                            </tr>
                        </tbody>
