    ...
    return (
        <MasterLayout>
            ...
            <HeaderTitle
                ...
                to="/app/quotations"
                editLink={getPermission(allConfigData?.permissions, Permissions.EDIT_QUOTATIONS) && `/app/quotations/edit/${id}`}
            />
                        ...
                        <Row className="custom-line-height">
                            <Col md={4}>
                                ...
                                <div className="p-4">
                                    ...
                                    {quotationDetails.customer &&
                                            quotationDetails.customer.email && <div className="d-flex align-items-center pb-1">
                                        <FontAwesomeIcon
                                            icon={faEnvelope}
                                            className="text-primary me-2 fs-5"
                                        />
                                    ...
                                    {quotationDetails.customer &&
                                            quotationDetails.customer.phone && <div className="d-flex align-items-center pb-1">
                                        <FontAwesomeIcon
                                            icon={faMobileAlt}
                                            className="text-primary me-2 fs-5"
                                        />
                                    ...
                                    {quotationDetails.customer &&
                                            quotationDetails.customer.address && <div className="d-flex align-items-center">
                                        <FontAwesomeIcon
                                            icon={faLocationDot}
                                            className="text-primary me-2 fs-5"
                                        />
                                ...
                                <div className="p-4">
                                    <div className="d-flex align-items-center pb-1">
                                        ...
                                        {quotationDetails.company_info &&
                                            (quotationDetails.company_info.company_name ?? "N/A")}
                                    </div>
                                    <div className="d-flex align-items-center pb-1">
                                        <FontAwesomeIcon
                                            icon={faEnvelope}
                                        ...
                                        />
                                        {quotationDetails.company_info &&
                                            (quotationDetails.company_info.email ?? "N/A")}
                                    </div>
                                    <div className="d-flex align-items-center pb-1">
                                        <FontAwesomeIcon
                                            icon={faMobileAlt}
                                        ...
                                        />
                                        {quotationDetails.company_info &&
                                            (quotationDetails.company_info.phone ?? "N/A")}
                                    </div>
                                    <div className="d-flex align-items-center">
                                        ...
                                        />
                                        {quotationDetails.company_info &&
                                            (quotationDetails.company_info.address ?? "N/A")}
                                    </div>
                                </div>
                            </Col>
                            <Col md={4}>
