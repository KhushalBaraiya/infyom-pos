        ...
        <>
            ...
            >
                <SidebarHeader className="aside-menu-container__aside-logo flex-column-auto pb-2 pt-3">
                    {  (!config?.includes(Permissions.MANAGE_CUSTOMER_DASHBOARD)) ?  <DropdownButton
                        id="store-dropdown"
                        title={
                    ...
                    >
                     ...
                     <div
                        className="text-gray-900 fs-4 w-100 d-flex justify-content-start align-items-center"
                    >
                        <div
                            className={`${
                                isMenuCollapse
                                    ? "d-none"
                                    : " w-50 d-flex justify-content-start"
                            }`}
                        >
                            <img
                                src={
