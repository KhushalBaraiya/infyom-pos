...
const EditSaleReturn = ( props ) => {
    ...
    const itemsValue = salesReturn && salesReturn.attributes && {
        ...
        wallet_amount: salesReturn.attributes.customer_wallet_amount,
        refunded_amount: salesReturn?.attributes?.wallet_refund_amount,
        warehouse_id: {
        ...
        wallet_payment_amount: salesReturn.attributes.sale_wallet_payment_amount,
    };
    ...
    return (
        <MasterLayout>
            ...
            {isLoading ? <Spinner /> :
                salesReturn && <SaleReturnForm singleSale={itemsValue} id={id} customers={customers} warehouses={warehouses} isEdit />}
        </MasterLayout>
    )
}
