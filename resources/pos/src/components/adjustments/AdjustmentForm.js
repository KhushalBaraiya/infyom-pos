...
const AdjustmentForm = (props) => {
    ...
    const handleValidation = () => {
        ...
        } else if (validateFiscalDate(adjustMentValue.date)) {
            error["date"] = validateFiscalDate(adjustMentValue.date);
    ...
    return (
        <div className="card">
            <TabTitle title={placeholderText(singleAdjustMent ? "adjustments.edit.title" : "adjustments.create.title")} />
                    ...
                    <div className="col-md-4">
                        ...
                        <div className="position-relative">
                            <ReactDatePicker
                                ...
                                {...(!isFiscalYearEnabled && { newStartDate: adjustMentValue.date })} FixedFiscalYearDate={true}
                            />
                        </div>
...
const mapStateToProps = (state) => {
    const { purchaseProducts, products, settings, isLoading } = state;
    return {
