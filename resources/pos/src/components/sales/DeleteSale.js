...
const DeleteSale = (props) => {
    const {deleteSale, onDelete, deleteModel, onClickDeleteModel, setNotDeletedItemModal, clearSelectedDeleteItem} = props;

    const deleteSaleClick = () => {
        deleteSale({ id: onDelete }, setNotDeletedItemModal, clearSelectedDeleteItem);
