...
import { fetchCustomerSalesReturn } from "../../store/action/salesReturnAction";
import {
...
import { DownloadCustomerSaleReturnPdf } from "../../store/action/downloadSaleReturnPdfAction";
...
import DeleteSaleReturn from "../saleReturn/DeleteSaleReturn";

const CustomerPurchaseReturn = (props) => {
    const {
        salesReturn,
        totalRecord,
        isLoading,
        frontSetting,
        DownloadCustomerSaleReturnPdf,
        allConfigData,
        isCallFetchDataApi,
        fetchCustomerSalesReturn
    } = props;
    ...
    const onChange = (filter) => {
        fetchCustomerSalesReturn(filter, true);
    };
    ...
    const onPdfClick = (id) => {
        DownloadCustomerSaleReturnPdf(id);
    };

    const goToDetailScreen = (id) => {
        window.location.href = "#/app/purchase-return/detail/" + id;
    };
        ...
        },
        {
            ...
            cell: (row) => (
                <ActionDropDownButton
                    ...
                    isViewIcon={getPermission(allConfigData?.permissions, Permissions.MANAGE_CUSTOMERS_PURCHASE)}
    ...
    return (
        <MasterLayout>
            <TopProgressBar />
            <TabTitle title={placeholderText("dashboard.purchaseReturn.title")} />
