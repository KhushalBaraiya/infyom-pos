...
export const deletePurchaseReturn = (purchaseId, setNotDeletedItemModal, clearSelectedDeleteItem) => async (dispatch) => {
    apiConfig
        .delete(apiBaseURL.PURCHASES_RETURN, { data: purchaseId })
        .then((response) => {
