...
export const addBrand = (brands, setProductValue) => async (dispatch) => {
    await apiConfig
...
export const deleteBrand = (brandsId, setNotDeletedItemModal, clearSelectedDeleteItem) => async (dispatch) => {
    apiConfig
        .delete(apiBaseURL.BRANDS, { data: brandsId })
        .then((response) => {
