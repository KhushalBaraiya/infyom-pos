...
export const addUser = (users, navigate, redirect = true, setShowPasswordModal) => async (dispatch) => {
...
export const deleteUser = (userId, setNotDeletedItemModal, clearSelectedDeleteItem) => async (dispatch) => {
    apiConfig
        .delete(apiBaseURL.USERS, { data: userId })
        .then((response) => {
