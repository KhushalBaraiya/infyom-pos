...
import apiConfigWithoutFormData from "../../config/apiConfig";
...
export const deleteMainProduct = (productId, setNotDeletedItemModal, clearSelectedDeleteItem) => async (dispatch) => {
    apiConfigWithoutFormData
        .delete(apiBaseURL.MAIN_PRODUCTS, { data: productId })
        .then((response) => {
