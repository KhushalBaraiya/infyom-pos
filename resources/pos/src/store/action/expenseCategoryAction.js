...
export const deleteExpenseCategory = (expensesId, setNotDeletedItemModal, clearSelectedDeleteItem) => async (dispatch) => {
    apiConfig
        .delete(apiBaseURL.EXPENSES_CATEGORIES, { data: expensesId })
        .then((response) => {
