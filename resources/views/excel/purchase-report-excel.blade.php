...
<table width="100%" cellspacing="0" cellpadding="10" style="margin-top: 40px;">
    ...
    @foreach($purchases  as $purchase)
        <tr align="center">
            ...
            <td>{{$purchase->warehouse ? $purchase->warehouse->name : ''}}</td>
            <td>{{ currencyAlignment((float) $purchase->grand_total, 2) }}</td>
            <td>{{ currencyAlignment((float) $purchase->paid_amount, 2) }}</td>
