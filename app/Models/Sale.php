...
class Sale extends BaseModel implements HasMedia, JsonResourceful
{
    ...
    public function prepareAttributes(): array
    {
        ...
        $fields = [
            ...
            'customer_wallet_amount' => $this->customer->wallet->amount ?? 0,
            'wallet_payment_amount' => $this->payments()
                ->whereHas('paymentMethod', function ($query) {
                    $query->where('type', PaymentMethod::CUSTOMER_WALLET);
                })
                ->sum('amount') ?? 0,
            'wallet_refund_amount' => $this->wallet_refund_amount ?? 0,
            ...
            'discount_type' => $this->discount_type ?? 1,
