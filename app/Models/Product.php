 ...
 * @property float|null $product_wholesale_price
 * @property float|null $product_special_price
...
class Product extends BaseModel implements HasMedia, JsonResourceful
{
    ...
    protected $casts = [
        'product_cost' => 'float',
        'product_price' => 'float',
        'product_wholesale_price' => 'float',
        'product_special_price' => 'float',
        'grand_total' => 'float',
        'order_tax' => 'float',
    ];
    ...
    public function prepareAttributes(): array
    {
        ...
        $fields = [
            ...
            'product_wholesale_price' => $this->product_wholesale_price,
            'product_special_price' => $this->product_special_price,
    ...
    public function prepareProducts(): array
    {
        ...
        return [
            ...
            'product_wholesale_price' => $this->product_wholesale_price,
            'product_special_price' => $this->product_special_price,
            'wholesale_price' => $this->product_wholesale_price,
            'special_price' => $this->product_special_price,
